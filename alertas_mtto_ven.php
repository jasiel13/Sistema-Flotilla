...
if ($admin['tipo'] == 'administrador')
 {
  ...
  $admin = iniciarSession('usuarios', $conexion);
   ...
   {
    header('Location: '.RUTA.'alertas_mtto_ven2.php');
...
<head>
  ...
  <title>Alertas de vencimiento del mtto</title>
...
<h3 align="center">Alertas de Mantenimiento(fecha de vencimiento)
...
$('#table').load('scripts/tabla_alertas_mtto_ven.php');
});
</script>
</body>
</html>