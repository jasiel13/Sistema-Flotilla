...
$body = "<h2 align='center'>Vehículo: $vehiculo</h2>"."<h4 align='center'><a href='http://localhost/control_flotilla/registrar_llantas.php' style='text-decoration: none;
    padding: 10px;
    font-weight: 300;
    font-size: 15px;
    color: #ffffff;
    ...
    border-radius: 6px;
    border: 2px solid black;'>Ir a Registrar Neumáticos</a></h4>".
    "<br><h4 align='center'><a href='http://localhost/control_flotilla/alertas_llantas.php' style='text-decoration: none;
    padding: 10px;
    font-weight: 300;
    font-size: 15px;
    color: #ffffff;
...
try {
    ...
    $mail->Subject = 'Alerta de Cambio de Neumáticos';
    $mail->Body    = "<div style='color:white;background:#434444;width:500px;border-radius: 15px;border: 3px #00AFFF outset;'>
    <legend><h2 align='center'>Usted tiene un cambio de llantas pendiente del:</h2>   
    </legend>
     $body</div>";
    $mail->CharSet= 'UTF-8'; 
