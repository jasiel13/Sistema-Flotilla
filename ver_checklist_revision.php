...
<head>
  ...
  <title>Búsqueda de checklist revisión</title>
...
<h3 align="center">Buscar Checklist Revisión
...
<button type="button" class="btn btn-info hvr-pop" onclick="location.href='checklist_revision.php'">Checklist Revisión
</button>
</div>   
</div>
</form>
...
function muestradatos(){
    ...
    ObjetoAjax.open("POST", "scripts/tabla_ver_checklist_revision.php", true);
