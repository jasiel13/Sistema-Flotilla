...
$body = "<h2 align='center'>Vehículo: $vehiculo</h2>"."<h4 align='center'><a href='http://localhost/control_flotilla/reg_mantenimiento.php' style='text-decoration: none;
    padding: 10px;
    font-weight: 300;
    font-size: 15px;
    color: #ffffff;
    ...
    "<br><h4 align='center'><a href='http://localhost/control_flotilla/notificaciones.php' style='text-decoration: none;
    padding: 10px;
    font-weight: 300;
    font-size: 15px;
    color: #ffffff;
