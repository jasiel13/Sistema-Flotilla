...
<head>
  ...
  <title>Alertas de Incidentes</title>
...
<h3 align="center">Alertas de Incidente 
<i class="fa fa-bell fa-2x"></i></h3>
<p align="center">Estas alertas indican que tiene un plazo de 3 días como máximo para empezar a atender la incidencia</p> 
</div>

<!--CODIGO PARA FORMULARIO DE ACTUALIZAR CONDUCTOR-->
<div style="margin: 20px;">
 <div class="text-center card-box text-white bg-dark">
  <legend>Alerta de Atención al Incidente(vencimiento)
...
$('#table').load('scripts/tabla_alertas_incidentes2.php');
});
</script>
</body>
</html>