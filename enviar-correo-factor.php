...
$body = "<h2 align='center'>Vehículo: $vehiculo</h2>"."<h2 align='center'>Ticket: $ticket</h2>"."<h4 align='center'><a href='http://localhost/control_flotilla/reg_mantenimiento.php' style='text-decoration: none;
    padding: 10px;
    font-weight: 300;
    font-size: 15px;
    color: #ffffff;
    ...
    border-radius: 6px;
    border: 2px solid black;'>Ir a Registrar Mtto</a></h4>".
    "<br><h4 align='center'><a href='http://localhost/control_flotilla/alertas_porcentaje_km.php' style='text-decoration: none;
    padding: 10px;
    font-weight: 300;
    font-size: 15px;
    color: #ffffff;
...
try {
    ...
    $mail->Subject = 'Alerta de Diferencia en Kilometraje';
    $mail->Body    = "<div style='color:white;background:#434444;width:500px;border-radius: 15px;border: 3px #00AFFF outset;'>
    <legend><h2 align='center'>Usted tiene un diferencia de kilometraje:</h2>   
    </legend>
     $body</div>";
    $mail->CharSet= 'UTF-8'; 
