...
<head>
  ...
  <title>Tabla de Historial de Mantenimientos</title>
...
<th>Observaciones</th>
<th>Fecha próximo mtto</th>
</tr>
</thead>
<tbody>
<?php
$con=mysqli_connect("localhost","root","","controldeflotilla") or die (mysqli_error());
$query="SELECT  * FROM historial_mantenimiento";
...
$("#excel").click(function(){
  $("#exportar").table2excel({
    name: "Hoja 1",
    filename: "Historial de Mantenimientos",
    fileext: ".xls",
    preserveColors: true
  }); 
});
