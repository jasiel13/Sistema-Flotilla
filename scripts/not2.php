...
$result=mysqli_query($con, $query) or die (mysqli_error());
 ...
 $totalkm=$total+$row[0];
 $auto=$row['vehiculo'];
 $t=$totalkm;//para poder mostar la cantidad de kilometraje sin modificar tal como se trae de la consulta y para hacer el mensaje de baja antes de completar los 5000km
}

//para comenzar a entrar al ciclo primero el kilometraje debe llegar a 5000km una vez que llegue se mete al ciclo,marcara la alerta "media" cuando por ejemplo sean 14,000km dira que supero los 10,000 y cuando ya diga 15,000 la alerta cambiara y dira que esta cerca de llegar a los 20,000.Cambia cada 5000km para decidir si es alta,media,baja.
   $excedido = 0;
    $mensaje;
    while($totalkm >= 10000){
      $excedido += 10000;
    ...
    if($t<=5000){
        $mensaje="Aún no necesita mantenimiento";
