...
<h3 align="center">Modificar Proveedor
...
<form class="container" id="frmprov" method="POST">
  ...
  <select  name="proveedor" id="proveedor" class="form-control" onchange="mifuncion3(this.value)">
      ...
      <p id="ms" style="display:none" class="error">Seleccione el proveedor que desea modificar</p>
    </div>
    ...
    <div class="form-group col-md-4">
      ...
      <p id="ms1" style="display:none" class="error">El campo tipo no puede estar vacío</p>
    </div>
    <div class="form-group col-md-4">
...
<button type="button" class="btn btn-warning hvr-rotate" onclick="deleteprov($('#proveedor').val())"><i class="fa fa-trash" style="color:black;"></i>  Eliminar</button>
...
// Primero validará el formulario.
  if(validaForm5()){ 
  $.post("scripts/actualizar_proveedor.php",$("#frmprov").serialize(),function(res){
...
function mifuncion3(valor){
    $.ajax({ 
     // la URL para la petición    
      url : 'scripts/carga_valoresprov.php',
...
function deleteprov(id){
  ...
  $.ajax({
      url : 'scripts/borrar_proveedor.php',
      data : { id : id },
      type : 'POST',
